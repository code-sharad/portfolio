...
function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      <div id="svg-sign-wrapper" className="flex mt-4 ml-4 lg:mt-8 lg:ml-8 z-[9999]">
        <svg
          id="svg-sign"
          width="70"
          height="80"
          ...
          className="w-16 h-auto drop-shadow-sm dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]"
        >
          <defs>
            <linearGradient id="signature-gradient" x1="0" y1="0" x2="229" y2="227" gradientUnits="userSpaceOnUse">

...
function Project(props: ProjectProps) {
  ...
  return (
    ...
    >
      <section className="relative max-w-[42rem] mb-28 overflow-hidden rounded-xl border border-black/5 bg-white/60 lg:bg-white/60 lg:backdrop-blur-sm shadow-md transition hover:bg-white/80 hover:shadow-xl ring-1 ring-black/5 sm:pr-8 sm:group-even:pl-8">
